...
public class ActualProjectsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actual_projects);
        ...
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.recyclerViewActualProjectsList);
        ...
        db.collection("Architectural Office")
                ...
                .collection("Projects")
                .whereEqualTo("actualProject",true)
                .get()
